...
import 'package:crypto_trading_app/models/trade.dart';
import 'package:crypto_trading_app/screens/currency_details_screen/components/trade_item.dart';
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (_, index) => Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(
              color: index == 0 ? kPrimaryColor : Colors.transparent
            ),
     ...
     body: Stack(
       children: [ListView(
        ...
        children: [
          ...
          const SizedBox(height: 36),
          if (currency.tradeHistory.isNotEmpty) tradeHistory(),
         ],
        ),
        Align(
